// Hand-picked Unsplash photos matched exactly to dish names
// Used as fallback when a recipe has no photo_url
const DISH_IMAGES = {
  // Italian
  'spaghetti carbonara':    'https://images.unsplash.com/photo-1612874742237-6526221588e3?w=600&q=80',
  ...
  'tuscan chicken':         'https://images.unsplash.com/photo-1598515213692-9aebd40d6a02?w=600&q=80',
  ...
  'miso ramen':             'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&q=80',
  ...
  'dumplings':              'https://images.unsplash.com/photo-1496116218417-1a781b1c416c?w=600&q=80',
  ...
  'chickpea curry':         'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=600&q=80',
  ...
  'biryani':                'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=600&q=80',
  'lamb biryani':           'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=600&q=80',
  'curry':                  'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=600&q=80',
  ...
  'beef tacos':             'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=600&q=80',
  'jackfruit tacos':        'https://images.unsplash.com/photo-1552332386-f8dd00dc2f85?w=600&q=80',
  ...
  'lamb tagine':            'https://images.unsplash.com/photo-1541518763669-27fef04b14ea?w=600&q=80',
  ...
  'beef bulgogi':           'https://images.unsplash.com/photo-1498654200943-1088dd4438ae?w=600&q=80',
  ...
  'vietnamese pho':         'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=600&q=80',
  ...
  'mango sticky rice':      'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=600&q=80',
  ...
  'lentil soup':            'https://images.unsplash.com/photo-1547592180-85f173990554?w=600&q=80',
  ...
  'roast chicken':          'https://images.unsplash.com/photo-1598515213692-9aebd40d6a02?w=600&q=80',
  'pancakes':               'https://images.unsplash.com/photo-1506084868230-bb9d95c24759?w=600&q=80',
...
export function getRecipeImage(recipe) {
  ...
  // Check exact or partial title matches
  for (const [key, url] of Object.entries(DISH_IMAGES)) {
    if (title.includes(key)) return url
  }

  // Fall back to varied default based on recipe id
